    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginTop: '1.5rem', fontSize: '0.875rem', color: '#666' }}>
          <p style={{ marginBottom: '0.5rem', fontWeight: '500' }}>Demo Users:</p>
          <ul style={{ listStyle: 'none', paddingLeft: '0' }}>
            <li>• john@acmecorp.com / password123</li>
            <li>• sarah@techstartup.io / password123</li>
            <li>• guest@example.com / password123</li>
          </ul>
        </div>
      </div>
    </div>
